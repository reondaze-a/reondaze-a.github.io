...
export default function Navbar() {
  ...
  return (
    <nav className={`sticky top-0 z-50 backdrop-blur-md bg-white/95 border-b border-white/20 shadow-lg ${open ? "" : "rounded-b-2xl"}`}>
      <div className="flex justify-between items-center px-3 py-4">
        ...
        <div className="flex md:hidden">
          <button onClick={() => setOpen(!open)} className="text-gray-700 hover:text-blue-600 transition-colors duration-300 p-1">
